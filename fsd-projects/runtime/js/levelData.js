    ...
    var levelData = [
      {
        ...
        gameItems: [
          ...
          { type: "reward", x: 700, y: groundY,damage:20,image: "img/silver coin.png", scaleX:.225, scaleY:.225, offsetX:-27, offsetY:-27, score:100, velocity:-1, hitZoneSize:25},
          { type: "reward", x: 900, y: groundY,damage:20,image: "img/gold coin.png", scaleX:.065, scaleY:.065, offsetX:-25, offsetY:-25, score:100, velocity:-1, hitZoneSize:25},
          { type: "levelMarker", x: 1300, y: groundY-50,damage:20,image: "img/endLevel.png", scaleX:.75, scaleY:.76, offsetX:-300, offsetY:-418, score:100, velocity:-1, hitZoneSize:50},
        ],
      },
      {
        name: "Robot Rampage",
        ...
        speed: -3,
        gameItems: [
          { type: "reward", x: 900, y: groundY,damage:20,image: "img/key.png", scaleX:1, scaleY:1, offsetX:-25, offsetY:-25, score:100, velocity:-1, hitZoneSize:25},
          { type: "enemy", x: 400, y: groundY-50,damage:-20,image: "img/arrow (1).png", scaleX:.25, scaleY:.25, offsetX:-27, offsetY:-27, score:100, velocity:-1, hitZoneSize:25},
          { type: "obstacle", x: 900, y: groundY,damage:101, rotation: 5, image:"img/sawblade (2).png", scaleX: 1, scaleY: 1, offsetX: -28, offsetY:-28 },
        ],
      },
    ];
