  ...
  window.opspark.makeDataInGame = function (game) {
    ...
    var levelData = [
      ...
      },
      {
        ...
        speed: -3,
        gameItems: [
          { type: "reward", x: 1300, y: groundY,heal:20,image: "img/key.png", scaleX:1, scaleY:1, offsetX:-25, offsetY:-25, score:100, velocity:-1, hitZoneSize:25},
          ...
          { type: "obstacle", x: 1480, y: groundY-20,damage:101, rotation: 0, image:"img/spike (1).png", scaleX: .70, scaleY: .60, offsetX: -43, offsetY:-53, hitZone:45 },
          { type: "obstacle", x: 1570, y: groundY-20,damage:101, rotation: 0, image:"img/spike (1).png", scaleX: .70, scaleY: .60, offsetX: -43, offsetY:-53, hitZone:45 },
          { type: "obstacle", x: 1660, y: groundY-20,damage:101, rotation: 0, image:"img/spike (1).png", scaleX: .70, scaleY: .60, offsetX: -43, offsetY:-53, hitZone:45 },
          { type: "obstacle", x: 1750, y: groundY-20,damage:101, rotation: 0, image:"img/spike (1).png", scaleX: .70, scaleY: .60, offsetX: -43, offsetY:-53, hitZone:45 },
        ],  
      },
    ];
